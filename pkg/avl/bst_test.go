...
func requireValue(t testingCtx, tr *avl.BST[string, string], key string, value string) {
	t.Helper()
...
func requireMissing(t testingCtx, tr *avl.BST[string, string], key string) {
	t.Helper()
...
func randomDataCreation(t testingCtx, tr *avl.BST[string, string], cache map[string]string, maxKey int, oprCnt int, deletionMultiple int) {
...
func randomDataValidation(t testingCtx, tr *avl.BST[string, string], cache map[string]string, maxKey int) {
